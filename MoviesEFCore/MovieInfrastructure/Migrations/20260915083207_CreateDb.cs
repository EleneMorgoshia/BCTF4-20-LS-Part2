    ...
    public partial class CreateDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudiosDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StudiosDetails_Studios_StudioId",
                        column: x => x.StudioId,
                        principalTable: "Studios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MoviesActors", x => new { x.ActorsId, x.MoviesId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudiosDetails_StudioId",
                table: "StudiosDetails",
                column: "StudioId",
                unique: true);
        }
