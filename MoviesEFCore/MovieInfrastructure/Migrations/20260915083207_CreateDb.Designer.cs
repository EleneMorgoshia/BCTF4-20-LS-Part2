...
namespace Movie.Infrastructure.Migrations
{
    ...
    [Migration("20260915083207_CreateDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Movie.Domain.Entities.StudioDetails", b =>
                {
                    ...
                    b.ToTable("StudiosDetails");
                });

            modelBuilder.Entity("ActorMovie", b =>
                {
                    b.HasOne("Movie.Domain.Entities.Actor", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Movie.Domain.Entities.Movie", b =>
                {
                    b.HasOne("Movie.Domain.Entities.Studio", "Studio")
                        .WithMany("Movies")
            ...
            modelBuilder.Entity("Movie.Domain.Entities.StudioDetails", b =>
                {
                    b.HasOne("Movie.Domain.Entities.Studio", "Studio")
                        ...
                        .HasForeignKey("Movie.Domain.Entities.StudioDetails", "StudioId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
